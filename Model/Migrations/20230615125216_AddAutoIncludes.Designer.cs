...
namespace Model.Migrations
{
    ...
    [Migration("20230615125216_AddAutoIncludes")]
    partial class AddAutoIncludes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLogs.TileGift", b =>
                {
                    b.HasBaseType("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLog");

                    b.ToTable("TILE_GIFTS");
                });
            ...
            modelBuilder.Entity("Model.Entities.MonolithArena.InGame.Logs.TileLog", b =>
                {
                    b.HasOne("Model.Entities.MonolithArena.InGame.GameLog", null)
                        .WithOne()
                        .HasForeignKey("Model.Entities.MonolithArena.InGame.Logs.TileLog", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLog", b =>
                {
                    ...
                    b.HasOne("Model.Entities.MonolithArena.InGame.Logs.TileLog", null)
                        .WithOne()
                        .HasForeignKey("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLog", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLogs.TileFieldDirectionLog", b =>
                {
                    ...
                    b.HasOne("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLog", null)
                        .WithOne()
                        .HasForeignKey("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLogs.TileFieldDirectionLog", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLogs.TileGift", b =>
                {
                    b.HasOne("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLog", null)
                        .WithOne()
                        .HasForeignKey("Model.Entities.MonolithArena.InGame.Logs.TileLogs.TileFieldLogs.TileGift", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
